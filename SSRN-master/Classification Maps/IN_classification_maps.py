...
for index_iter in xrange(ITER):
    ...
    best_weights_RES_path_ss4 = 'C:\Users\josep\Desktop\RS\residualnet_tensorflow_keras\residualnet_tensorflow_keras\SSRN-master\models\Indian_best_RES_3D_SS4_10_' + str(
        index_iter + 1) + '.hdf5'
...
#    train_indices, test_indices = sampleFixNum.samplingFixedNum(TRAIN_NUM, gt)
    ...
    classification_map(y_re, gt_IN, 24, "C:\Users\josep\Desktop\RS\residualnet_tensorflow_keras\residualnet_tensorflow_keras\SSRN-master\Cmaps/RES4_SS_IN.png")
